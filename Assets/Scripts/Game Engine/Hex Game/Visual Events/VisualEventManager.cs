...
namespace WeAreGladiators.VisualEvents
{
    public static class VisualEventManager
    {
        ...
        public static VisualEvent InsertTimeDelayInQueue(float delayDuration, VisualEvent parentEvent = null)
        {
            ...
            if (parentEvent != null && !parentEvent.isClosed)
            {
        ...
        {
            if (VisualEventUpdater.Instance != null)
            {
                return;
            }
        ...
        public static List<VisualEvent> EventQueue { get; private set; } = new List<VisualEvent>();
        ...
        private static async void PlayEventFromQueue(VisualEvent ve)
        {
            ...
            if (ve.startDelay > 0)
            {
                await Task.Delay((int) (ve.startDelay * 1000));
            }
            ...
            if (ve.endDelay > 0)
            {
                await Task.Delay((int) (ve.endDelay * 1000));
            }
        ...
        private static async void PlayEventFromStackEvent(VisualEvent childEvent, VisualEvent parentEvent)
        {
            ...
            {
                await Task.Delay((int) (childEvent.startDelay * 1000));
            }
            ...
            {
                while (childEvent.cData.Complete() == false)
                {
            ...
            {
                await Task.Delay((int) (childEvent.endDelay * 1000));
            }
        ...
        public static VisualEvent HandleEventQueueTearDown()
        {
            ...
            PauseQueue();
            if (EventQueue.Count > 0 && currentEventPlaying)
            {
        ...
        public static VisualEvent CreateStackParentVisualEvent(HexCharacterModel character)
        {
