...
namespace WeAreGladiators.TownFeatures
{
    public class TownBuildingView : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEvent pageBuildFunction;
        ...
        #region Core Logic
        private IEnumerator LeaveFeature()
        {
        ...
        private IEnumerator EnterFeature()
        {
            yield return null;
