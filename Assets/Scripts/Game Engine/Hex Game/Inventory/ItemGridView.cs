...
namespace WeAreGladiators.Items
{
    public class ItemGridView : MonoBehaviour
    {
        ...
        //[SerializeField] private GameObject goldVisualParent;
        //[SerializeField] private TextMeshProUGUI goldAmountText;

        [Header("Cost Components")]
        [SerializeField] private GameObject itemCostParent;
        [SerializeField] private TextMeshProUGUI itemValueText;

        public static ItemGridView ItemDragged { get; private set; }
        ...
        public GameObject ItemCostParent => itemCostParent;
        ...
        private void OnMouseUp()
        {
            if (currentlyBeingDragged)
            {
                   ...
                   )
                {
                    ...
                    InventorySlot slot = InventoryController.Instance.AllInventorySlots[InventoryController.Instance.PlayerInventory.IndexOf(MyItemRef)];
