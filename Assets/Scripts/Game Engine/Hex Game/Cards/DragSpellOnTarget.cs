...
namespace WeAreGladiators.Cards
{
    public class DragSpellOnTarget : DraggingActions
    {
        ...
        public override void OnStartDrag()
        {
            ...
            TargettingArrowController.Instance.EnableArrow(cardVM);
        ...
        public override void OnEndDrag(bool forceFailure = false)
        {
            ...
            if (cardVM.eventSetting == EventSetting.Camping)
            {
                ...
                RaycastHit[] hits;
                hits = Physics.RaycastAll(CameraController.Instance.MainCamera.ScreenPointToRay(Input.mousePosition), 1000.0f);
