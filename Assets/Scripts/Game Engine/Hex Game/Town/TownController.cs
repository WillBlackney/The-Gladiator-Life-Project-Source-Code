...
namespace HexGameEngine.TownFeatures
{
    public class TownController : Singleton<TownController>
    {
        ...
        [SerializeField] private CharacterRecruitTab[] allCharacterRecruitTabs;
        ...
        private CharacterRecruitTab selectedRecruitTab;
        ...
        {
            // Reset recruit tabs
            foreach (CharacterRecruitTab tab in allCharacterRecruitTabs)
        ...
        private void BuildRecruitTabFromCharacterData(CharacterRecruitTab tab, HexCharacterData data)
        {
        ...
        public void OnCharacterRecruitTabClicked(CharacterRecruitTab tab)
        {
