...
namespace Spriter2UnityDX.Importing
{
    ...
    public class Ref : ScmlElement
    {
        ...
        [XmlAttribute] public float z_index
        {
            ...
            get => z; //I choose to use position_z instead of order in layer because there are just potentially way too many
    ...
    public class SpatialInfo
    {
        ...
        [XmlAttribute] public float angle
        {
            ...
            get => rotation.eulerAngles.z; //So we're translating the angle to a quaternion
