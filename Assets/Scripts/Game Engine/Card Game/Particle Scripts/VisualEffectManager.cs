...
namespace CardGameEngine
{
    public class VisualEffectManager : Singleton<VisualEffectManager>
    {
        ...
        public void CreateOldDamageEffect(Vector3 location, int damageAmount, bool heal = false, bool healthLost = true)
        {
        ...
        public void CreateNewDamageEffect(Vector3 location, int damageAmount, bool crit = false)
        {
            GameObject damageEffect = Instantiate(DamageEffectPrefab, location, Quaternion.identity);
            damageEffect.GetComponent<DamageEffect>().InitializeSetup(damageAmount, crit);
        }
        ...
        public void CreateLoseBlockEffect(Vector3 location, int blockLost)
        {
            ...
            CreateOldDamageEffect(location, blockLost, false, false);
