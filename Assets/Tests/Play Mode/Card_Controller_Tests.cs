...
namespace Tests
{
    public class Card_Controller_Tests
    {
        ...
        public IEnumerator Setup()
        {
            ...
            GameObject.FindObjectOfType<CardGameEngine.GlobalSettings>().gameMode = StartingSceneSetting.IntegrationTesting;
        ...
        public void Power_Card_Is_Removed_From_All_Character_Collections_When_Played()
        {
            ...
            CharacterEntityModel model;
            bool expected;
            CardGameEngine.GlobalSettings.Instance.onPowerCardPlayedSetting = OnPowerCardPlayedSettings.RemoveFromPlay;
        ...
        public void Power_Card_Is_Expended_When_Played()
        {
            ...
            CharacterEntityModel model;
            bool expected;
            CardGameEngine.GlobalSettings.Instance.onPowerCardPlayedSetting = OnPowerCardPlayedSettings.Expend;
        ...
        public void Power_Card_Is_Shuffled_To_Discard_Pile_When_Played_From_Hand()
        {
            // Arange
            CharacterEntityModel model;
            CardGameEngine.GlobalSettings.Instance.onPowerCardPlayedSetting = OnPowerCardPlayedSettings.MoveToDiscardPile;
            deckData.Clear();
        ...
        public void Innate_Card_Is_Drawn_In_Opening_Hand()
        {
            ...
            CardGameEngine.GlobalSettings.Instance.innateSetting = InnateSettings.PrioritiseInnate;
        ...
        public void Innate_Cards_Are_Drawn_Extra_In_Opening_Hand()
        {
            ...
            CardGameEngine.GlobalSettings.Instance.innateSetting = InnateSettings.DrawInnateCardsExtra;
